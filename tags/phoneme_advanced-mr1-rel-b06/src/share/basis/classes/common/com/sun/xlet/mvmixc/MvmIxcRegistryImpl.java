...
public class MvmIxcRegistryImpl extends IxcRegistry {
  
    // <XletContext, MvmIxcRegistryImpl>  
    ...
    CDCAmsAppManagerStub amHandler; 
    ...
    public static IxcRegistry getIxcRegistryImpl(XletContext context) {
       ...
       synchronized(ixcRegistries) {
           ...
           if (isAppManager) {
              ...
              // of ServiceRegistry instead of a regular MvmIxcRegistryImpl.
              try {
                 Class c = Class.forName("com.sun.xlet.mvmixc.ServiceRegistry");
           ...
           if (regis == null) {
              regis = new MvmIxcRegistryImpl(context);
           }
    ...
    /* Check whether the first item on the ExportedObject list
       is an CDCAmsIxcRegistry object. */
    private static boolean isAppManagerVM() {
       ...
       return (remoteClassName.indexOf("CDCAmsIxcRegistry") != -1);
    }

    protected MvmIxcRegistryImpl(XletContext context) {
        super();
        this.context = context;
        this.amHandler = new CDCAmsAppManagerStub(context);
