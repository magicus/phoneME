/*
 * @(#)AWTEventMulticaster.java	1.19 03/11/25
 *
...
public class AWTEventMulticaster implements 
        ...
        ActionListener, ItemListener, AdjustmentListener, InputMethodListener,
    ...
    /*
     * Recusive method which populates EventListener array a with EventListeners     * from l.  l is usually an AWTEventMulticaster.  Bug 4513402 revealed that
