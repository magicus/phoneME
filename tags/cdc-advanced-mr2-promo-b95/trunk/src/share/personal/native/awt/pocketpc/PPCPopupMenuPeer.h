/*
 * @(#)PPCPopupMenuPeer.h	1.6 06/10/10
 *
 ...
 *
 */
#ifndef _WINCEPOPUPMENU_PEER_H_
#define _WINCEPOPUPMENU_PEER_H_
...
//
// Menu class for accessing a popup HMENU
//
...
public:
    ...
    static AwtPopupMenu* Create(jobject self,
                                AwtComponent* parent);

    // Display the popup modally.
    void Show(jobject evt);

    virtual AwtMenuBar* GetMenuBar() { return NULL; }
    INLINE AwtMenu* GetParent() { return NULL; }
    INLINE void SetParentMenu(AwtMenu* parent) { ASSERT(FALSE); }
