...
public class Utils {
    ...
    private static String mtaskClientID;
    static String getMtaskClientID() {
       if (mtaskClientID == null) {
          try {
             Class clazz = Class.forName("com.sun.appmanager.client.Client");
             if (clazz != null) {
                Method m = clazz.getMethod("getClientId", new Class[]{});
                mtaskClientID = (String) m.invoke(null, new Object[]{});
             }
          } catch (Exception e) {
             mtaskClientID = "UNDEFINED";
          }
       }
