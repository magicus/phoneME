...
public class RemoteRef implements Remote, Serializable{
   ...
   private int portID;
   private String xletID;

   String[] interfaceNames;
   long[] methodIDs;

   public RemoteRef(long objectID, int portID, String xletID,
   ...
   String getXletID()    { return xletID; }

   void dump() {
      System.out.println("ObjectID = " + objectID);
      System.out.println("portID   = " + portID);
      System.out.println("XletID   = " + xletID);
   ...
   public String toString() {
      StringBuffer buf = new StringBuffer("RemoteRef[ObjectID=" 
              + objectID + ",portID=" + portID + ",XletID=" + 
              xletID+",RemoteInterfaces=<");
      int i = 0;
