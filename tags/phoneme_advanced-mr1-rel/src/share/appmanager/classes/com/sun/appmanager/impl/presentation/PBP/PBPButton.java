...
/**
 */
public class PBPButton extends Component {
    public static final Font DEFAULT_FONT = new Font("sanserif", Font.BOLD, 12);
...
//            FocusEvent.FOCUS_LOST
    ...
    protected void processMouseEvent(MouseEvent e) {
        ...
        case MouseEvent.MOUSE_RELEASED:
            ...
            for (int i = 0; i < listeners.size(); i++) {
                PBPButtonListener listener = (PBPButtonListener) listeners.get(i);
    ...
    public synchronized void addPBPButtonListener(PBPButtonListener listener) {
        listeners.add(listener);
    }

    public synchronized void removePBPButtonListener(PBPButtonListener listener) {
