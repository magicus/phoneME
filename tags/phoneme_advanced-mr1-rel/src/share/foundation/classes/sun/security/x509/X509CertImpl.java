...
/*
 * Note that there are two versions of X509CertImpl, this
 * subsetted one for CDC/FP and another for the security optional
 * package. Be sure you're editing the right one!
 */
...
public class X509CertImpl extends X509Certificate implements DerEncoder {
     ...
     * certificate)
     * CDC/FP moves CRLDistributionPointsExtension to the
	...
	try {
		...
		for (Enumeration e=extensions.getElements(); e.hasMoreElements();) {
			...
			// May want to consider cloning this
			return ex;
		}
     ...
     * New API subsetted out in CDC/FP and cannot be invoked here. It
     * appears to be invoked only certpath code & exists in the
     * security optional package version of this class.
