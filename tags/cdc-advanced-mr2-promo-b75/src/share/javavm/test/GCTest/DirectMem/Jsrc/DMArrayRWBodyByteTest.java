/*
 * @(#)DMArrayRWBodyByteTest.java	1.6 06/10/10
 *
...
public class DMArrayRWBodyByteTest extends Thread {

   private byte [] privateArray;
   public static Object lock;

   public DMArrayRWBodyByteTest(int num) {
   ...
   public void run() {
      ...
      if(pass)
         System.out.println("PASS: DMArrayRWBodyByteTest, Data written and read were same");
      else
         System.out.println("FAIL: DMArrayRWBodyByteTest, Data written and read were not same");
   }
   ...
   public static void main(String args[]) {
      ...
      DMArrayRWBodyByteTest.lock = lck;
      GcThread.lock = lck;

      GcThread gc = new GcThread();
      DMArrayRWBodyByteTest test = new DMArrayRWBodyByteTest(rd.nextInt(100));
