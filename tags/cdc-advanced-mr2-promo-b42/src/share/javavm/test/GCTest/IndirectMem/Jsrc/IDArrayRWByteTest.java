/*
 * @(#)IDArrayRWByteTest.java	1.6 06/10/10
 *
...
public class IDArrayRWByteTest extends Thread {

   private byte [] privateArray;

   public IDArrayRWByteTest(int num) {
   ...
   public void run() {
      ...
      if(pass)
         System.out.println("PASS: IDArrayRWByteTest, Data written and read were same");
      else
         System.out.println("FAIL: IDArrayRWByteTest, Data written and read were not same");
   }
   ...
   public static void main(String args[]) {
      ...
      IDArrayRWByteTest test = new IDArrayRWByteTest(rd.nextInt(100));
