...
/* @test @(#)URITest.java	1.23 06/10/10
 * @summary Unit test for java.net.URI
 * @bug 4464135 4505046 4503239 4438319
...
public class URITest {
    ...
    static URITest test(String s) {
	return new URITest(s);
    }

    private URITest(String s, String u, String h, int n,
    ...
    static URITest test(String s, String u, String h, int n,
		     String p, String q, String f) {
	return new URITest(s, u, h, n, p, q, f);
    }

    private URITest(String s, String a,
		 String p, String q, String f)
    {
	testCount++;
	try {
    ...
    static URITest test(String s, String a,
		     String p, String q, String f) {
	return new URITest(s, a, p, q, f);
    }

    private URITest(String s, String h, String p, String f) {
	testCount++;
	try {
	    uri = new URI(s, h, p, f);
	} catch (URISyntaxException x) {
    ...
    static URITest test(String s, String h, String p, String f) {
	return new URITest(s, h, p, f);
    }

    private URITest(String s, String ssp, String f) {
	testCount++;
	try {
	    uri = new URI(s, ssp, f);
	} catch (URISyntaxException x) {
    ...
    static URITest test(String s, String ssp, String f) {
	return new URITest(s, ssp, f);
    }

    private URITest(String s, boolean xxx) {
	testCount++;
	try {
	    uri = URI.create(s);
    ...
    static URITest testCreate(String s) {
	return new URITest(s, false);
    }
...

    // Operations on URITest instances
    //
...

	...
	// URITest hostnames that might initially look like IPv4 addresses
...

	...
	case 0:
	    tests();
	    out.println();
	    out.println("URITest cases: " + testCount);
	    break;
