...
#ifndef _VXWORKS_DEFS_MD_H
#define _VXWORKS_DEFS_MD_H

/* for CPU definitions */
#include <types/vxCpu.h>

/*
 * VxWorks uses types common to gcc
 */
...
#define CVM_HDR_ANSI_CTYPE_H	"javavm/include/ctype_md.h"
#define CVM_HDR_ANSI_SETJMP_H	"javavm/include/setjmp_md.h"
#define CVM_HDR_ANSI_STRING_H	"javavm/include/string_md.h"
...
#define CVM_ADV_SCHEDLOCK
#define CVM_ADV_MUTEX_SET_OWNER

#undef CVM_HAVE_PROCESS_MODEL

#endif /* _VXWORKS_DEFS_MD_H */
