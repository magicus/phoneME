/*
 * @(#)PPCImageRepresentation.java	1.6 06/10/10
 * 
...
/** Defines the representation used to store images in MFC. The image is 
    stored as a PPC pixmap (server side image). */

class PPCImageRepresentation extends ImageRepresentation {
    private static native void initIDs();
    static {
        initIDs();
    }
    PPCImageRepresentation (PPCImage image) {
        super(image, 0);
    }
