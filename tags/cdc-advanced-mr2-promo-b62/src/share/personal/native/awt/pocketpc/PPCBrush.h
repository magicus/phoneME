...
#ifndef _WINCE_BRUSH_H
#define _WINCE_BRUSH_H
...
public:
     ...
     * Release() must be called when the brush is no longer needed
     */
...
private:
    ...
    HBRUSH SafeCreateSolidBrush(COLORREF cr);
};

#endif // _WINCE_BRUSH_H
