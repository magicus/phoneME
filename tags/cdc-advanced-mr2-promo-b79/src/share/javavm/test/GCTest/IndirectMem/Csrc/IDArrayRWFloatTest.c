/*
 * @(#)IDArrayRWFloatTest.c	1.6 06/10/10
 *
...
#include <stdio.h>
#include "IDArrayRWFloatTest.h"


JNIEXPORT void JNICALL
Java_IDArrayRWFloatTest_nSetArray(JNIEnv *env, jobject obj, 
      ...
      CVMD_gcUnsafeExec( ee, {
         CVMD_gcSafeExec(ee, {
            ...
            for(i=0; i<arrayLength; i++) {
               CVMID_arrayReadFloat(ee, (CVMArrayOfFloatICell*) srcArray, i, val);
               CVMID_arrayWriteFloat(ee, (CVMArrayOfFloatICell*) dstArray, i, val);
            }
