/*
 * @(#)IDArrayRWRefTest.java	1.6 06/10/10
 *
...
public class IDArrayRWRefTest extends Thread {

   private String [] privateArray;

   public IDArrayRWRefTest(int num) {
   ...
   public void run() {
      ...
      if(pass)
         System.out.println("PASS: IDArrayRWRefTest, Data written and read were same");
      else
         System.out.println("FAIL: IDArrayRWRefTest, Data written and read were not same");
   }
   ...
   public static void main(String args[]) {
      ...
      IDArrayRWRefTest test = new IDArrayRWRefTest(rd.nextInt(100));
