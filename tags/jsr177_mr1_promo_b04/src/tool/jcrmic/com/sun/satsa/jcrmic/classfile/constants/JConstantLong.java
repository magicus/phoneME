/*
 * @(#)JConstantLong.java	1.3 04/12/06 @(#)
 *
...
/**
 *  This class represents 8-byte numeric long constant.
 */

public class JConstantLong extends JConstant {
     ...
     */
    public JConstantLong(JConstantPool cp) {
        super(cp);
    }
