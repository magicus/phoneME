...
/**
 * Do nothing.  This is intended to replace actions that we don't want to
 * be run.
 *
 */
public class NullProcessorAction implements ProcessorAction {
    public NullProcessorAction() {
    }
