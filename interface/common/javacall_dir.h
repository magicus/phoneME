 ...
 * @ingroup JTWI
 *
 * The following functions allow to iterate through all files in a 
 * given directory.
 * The following functionality is provided:
 * 
 * - Open a directory file list by calling javacall_dir_open().
 ...
 * 
 * @param path the name of a directory (can also be a partial file name).
 ...
 */
javacall_handle javacall_dir_open(javacall_const_utf16_string path);
...
/**
 * Returns the size of free space in storage for Java.
 *
 * @return free storage space for java.
 */
 ...
 * (usually this function will return '\\' or '/').
 *
 * @return file separator character in UTF-16 encoding.
 */
