...
/*
 * Forms request to the native engine and returns with JAVACALL_WOULD_BLOCK code 
 * OR checks if this Document is XHTMLDocument
 * 
 * 
 * @param handle Pointer to the object representing this document.
 * @param invocation_id Invocation identifier which MUST be used in the 
 *                  corresponding javanotify function.
 * @param context The context saved during asynchronous operation.
 * @param ret_value <code>true</code> if the Document is XHTMLDocument,
 * <code>false</code> otherwise. 
 * 
 * @return JAVACALL_OK if all done successfuly,
 *         JAVACALL_FAIL if error in native code occured
 ...
 *             context,
 *         JAVACALL_WOULD_BLOCK caller must call the 
 *             javacall_dom_document_is_xhtml_document_finish function to complete the 
 *             operation,
 *         JAVACALL_NOT_IMPLEMENTED when the stub was called
 */
javacall_result
javacall_dom_document_is_xhtml_document_start(javacall_handle handle,
                                              javacall_int32 invocation_id,
                                              void **context,
                                              /* OUT */ javacall_bool* ret_value);
 ...
 */
javacall_result
javacall_dom_document_is_xhtml_document_finish(void *context,
                                               /* OUT */ javacall_bool* ret_value);
