...
class QSoundMIDIPlayControl extends QSoundMIDIPlayBase {
    ...
    static private native int nInitMetaDataCtrl(int peer);      
    ...
    boolean open(boolean forceOpen)
    {
        ...
        dc = new QSoundMetaDataCtrl(nInitMetaDataCtrl(peer()));
    ...
    Control getControl(String controlType)
    {
        ...
        if (controlType.equals(BasicPlayer.vocName)) {
            ...
            r = tc;
        } else if (controlType.equals(BasicPlayer.mdcName)) {
            r = dc;
        } 
