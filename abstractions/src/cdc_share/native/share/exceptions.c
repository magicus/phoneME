...
const char* const jsropOutOfMemoryError = "java/lang/OutOfMemoryError";
/** 'C' string for java.lang.RuntimeException */
const char* const jsropRuntimeException = "java/lang/RuntimeException";
/** 'C' string for java.lang.NullPointerException */
const char* const jsropNullPointerException = "java/lang/NullPointerException";
/** 'C' string for java.lang.IllegalArgumentException */
const char* const jsropIllegalArgumentException = "java/lang/IllegalArgumentException";
