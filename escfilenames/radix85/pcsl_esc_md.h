 ...
 * - characters not allowed in file names (including the path separator)
 */
#define PCSL_ESC_MOREDIGITS_MD "`~!"  "^&*()-_+[]{}\\|;:',<>"
/*                              `~!@#$%^&*()-_=+[]{}\|;:'",.<>/? */
...
#define PCSL_ESC_BYTES_PER_TUPLE_MD 4
/*
     ( PCSL_ESC_RADIX == 16 ? 1 \
    :( PCSL_ESC_RADIX == 41 ? 2 \
    :( PCSL_ESC_RADIX == 64 ? 3 \
...
#define PCSL_ESC_FULL_TUPLE_MASK_MD 0xffffffff
/*
...
/* considering special characters as uppercase of digits */
