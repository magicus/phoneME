...
public class QSoundMIDIPlayer extends BasicPlayer implements Runnable, QSoundMIDIOut {
    ...
    /*
     * Without this unused field (byte bufferData[]) 
    ...
    public QSoundMIDIPlayer()
    {
        qsmc = new QSoundMIDIPlayControl(this);
        channels = new Vector(10);
        hasDataSource = false;
    }
    
    QSoundMIDIPlayer(QSoundMIDIPlayBase pb)
    {
        qsmc = pb;
        qsmc.setPlayer(this);
        channels = new Vector(10);
    ...
    {
        if(source == null)
            qsmc = new QSoundMIDINullPlayControl(this);
        ...
        {        
            ...
            try {
                ...
                if(!r) throw new MediaException("Bad MIDI Format");
            }
   ...
   public void run() {
    ...
    public String getContentType() {
        ...
        return ((source != null) 
            ...
            : DefaultConfiguration.MIME_AUDIO_MIDI);
    }
