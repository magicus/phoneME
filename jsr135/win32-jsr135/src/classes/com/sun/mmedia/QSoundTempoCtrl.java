...
public class QSoundTempoCtrl implements TempoControl
{
    private int peer;

    public QSoundTempoCtrl(int tc)
    {
        peer = tc;
    }
    ...
    private native int nGetTempo(int peer);
    
    public int getTempo()
    {
        return nGetTempo(peer); 
    }
    
    private native int nSetTempo(int peer, int millitempo);
    
    public int setTempo(int millitempo)
    {
        return nSetTempo(peer, millitempo); 
    }
