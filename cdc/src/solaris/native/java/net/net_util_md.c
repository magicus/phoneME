...
#define ia6_ipaddressID JNI_STATIC(java_net_Inet6Address, ia6_ipaddressID)
#define ia4_ctrID JNI_STATIC(java_net_Inet4Address, ia4_ctrID)
#define ia6_ctrID JNI_STATIC(java_net_Inet6Address, ia6_ctrID)
