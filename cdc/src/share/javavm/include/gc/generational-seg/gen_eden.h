...
/*
 * Eden is a single space generation that is scavenged fully on every 
 * "young" GC (most of the time, that is).
 */
typedef struct CVMGenEdenGeneration {
    CVMGeneration gen;

    CVMGenSpace*  eden;          /* Eden space */
    CVMGenSpace*  extraSpace;    /* Scratch space */
    CVMUint32     edenSize ;

    CVMBool       evacuationFailed;
} CVMGenEdenGeneration;
