/*
 * @(#)SunClipboard.java	1.10 06/10/10
 *
...
public class SunClipboard extends Clipboard {
    ...
    protected void initContext(Transferable contents) {
        contentsContext = AppContext.getAppContext();
    }
    ...
    protected void lostOwnershipImpl() {
        if (contentsContext != null) {
            ...
            contentsContext = null;             
            SunToolkit.postEvent(context, new PeerEvent(this, new Runnable() {
                        public void run() {
                            lostOwnership();
                        }
