/*
 * @(#)GdkGraphicsEnvironment.java	1.20 06/10/10
 * 
...
public class GdkGraphicsEnvironment extends GraphicsEnvironment {
    ...
    public String[] getAvailableFontFamilyNames() {
		...
		return GPlatformFont.getAvailableFontFamilyNames();
...
*/ 
    ...
    public String[] getAvailableFontFamilyNames(Locale l) {
		...
		/* FIXME... add the locale version to GPlatformFont */
    ...
    static String getNativeFontName(String name, int style) {
		...
		return GPlatformFont.getNativeFontName(name, style);
...
*/		
    ...
    private GdkGraphicsDevice graphicsDevice = new GdkGraphicsDevice();
