...
/** An image which represents an area of another image. It shares the same 
    pixel storage as the source. */

class PPCSubImage extends Image implements BufferedImagePeer, PPCDrawableImage {
    /** The source image for which this is a sub image of. */
    private PPCImage sourceImage;

    /** The area of the source image this is a sub image of. */
    private int x, y, width, height;

    /** The image producer. This is just a CropImageFilter on the origional 
        image. */
    private ImageProducer producer;
    PPCSubImage (PPCImage sourceImage, int x, int y, int width, 
                   int height) {
    ...
    public BufferedImage getSubimage(int x, int y, int w, int h) {
        ...
        return PPCToolkit.createBufferedImage(new PPCSubImage (sourceImage, x + this.x, y + this.y, width, height));
    }
