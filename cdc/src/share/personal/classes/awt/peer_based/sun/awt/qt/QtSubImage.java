...
class QtSubImage extends Image implements BufferedImagePeer, QtDrawableImage {

    /** The source image for which this is a sub image of. */
	
    private QtImage sourceImage;
    ...
    public BufferedImage getSubimage(int x, int y, int w, int h) {
        ...
        return QtToolkit.createBufferedImage(new QtSubImage (sourceImage, x + this.x, y + this.y, width, height));
    }
