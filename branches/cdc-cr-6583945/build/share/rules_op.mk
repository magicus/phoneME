...
$(JSR_MIDPPERMITTED_CLASSLIST): $(JSROP_JARS)
	...
	$(AT)$(CVM_JAVA) -cp  $(CVM_BUILD_TOP)/classes.jcc JavaAPILister \
	    -listapi:include=java/*,include=javax/*,include=javacard/*,include=org/xml/sax/*,include=org/w3c/dom/*,include=com/sprintpcs/*,input=$(JSROP_JARS_LIST)$(PS)$(MIDP_CLASSES_ZIP),cout=$(JSR_MIDPPERMITTED_CLASSLIST)
endif
