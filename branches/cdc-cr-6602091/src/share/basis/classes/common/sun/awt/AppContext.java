...
*
*        Hashtable clone = (Hashtable)threadGroup2appContext.clone();
*        Enumeration allAppContexts = clone.elements();
*
*        while (allAppContexts.hasMoreElements()) {
*            AppContext appContext = (AppContext)allAppContexts.nextElement();
*
