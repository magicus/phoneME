/*
 * @(#)DSAKeyPairGenerator.java	1.22 06/10/10
 *
...
implements java.security.interfaces.DSAKeyPairGenerator {
	 ...
	 */
	 ...
	 try {
	     ...
	     precomputedParams.put(new Integer(512), alg512);
	     precomputedParams.put(new Integer(768), alg768);
	     precomputedParams.put(new Integer(1024), alg1024);
	...
	super("DSA");
        // Bug 5079897, automatically initialize to 1024.
	...
	if (!generateNewParameters) {
	    Integer mod = new Integer(this.modlen);
