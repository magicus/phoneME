/*
 * @(#)DMArrayRWDoubleTest.java	1.6 06/10/10
 *
...
public class DMArrayRWDoubleTest extends Thread {

   private double [] privateArray;
   public static Object lock;

   public DMArrayRWDoubleTest(int num) {
   ...
   public void run() {
      ...
      if(pass)
         System.out.println("PASS: DMArrayRWDoubleTest, Data written and read were same");
      else
         System.out.println("FAIL: DMArrayRWDoubleTest, Data written and read were not same");
   }
   ...
   public static void main(String args[]) {
      ...
      DMArrayRWDoubleTest.lock = lck;
      GcThread.lock = lck;

      GcThread gc = new GcThread();
      DMArrayRWDoubleTest test = new DMArrayRWDoubleTest(rd.nextInt(100));
