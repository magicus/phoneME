/*
 * @(#)DMArrayRWBodyLongTest.java	1.6 06/10/10
 *
...
public class DMArrayRWBodyLongTest extends Thread {
   ...
   public void run() {
      ...
      if(pass)
         System.out.println("PASS: DMArrayRWBodyLongTest, Data written and read were same");
      else
         System.out.println("FAIL: DMArrayRWBodyLongTest, Data written and read were not same");
   }
