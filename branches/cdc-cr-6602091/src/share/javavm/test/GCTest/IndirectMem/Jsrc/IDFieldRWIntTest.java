/*
 * @(#)IDFieldRWIntTest.java	1.6 06/10/10
 *
...
public class IDFieldRWIntTest extends Thread {

   public int publicVar;
   private int privateVar;
   protected int protectedVar;

   public IDFieldRWIntTest() {
      publicVar = 0;
      privateVar = 0;
      protectedVar = 0;
   }
   ...
   public void run () {
      ...
      if(pass)
         System.out.println("PASS: IDFieldRWIntTest, Data written and read were same");
      else
         System.out.println("FAIL: IDFieldRWIntTest, Data written and read were not same");
   ...
   public static void main(String args[]) {
      ...
      IDFieldRWIntTest test = new IDFieldRWIntTest();
