/*
 * @(#)IDArrayRWByteTest.c	1.6 06/10/10
 *
...
#include <stdio.h>
#include "IDArrayRWByteTest.h"


JNIEXPORT void JNICALL
Java_IDArrayRWByteTest_nSetArray(JNIEnv *env, jobject obj, 
      ...
      CVMD_gcUnsafeExec( ee, {
         CVMD_gcSafeExec(ee, {
            ...
            for(i=0; i<arrayLength; i++) {
               CVMID_arrayReadByte(ee, (CVMArrayOfByteICell*) srcArray, i, val);
               CVMID_arrayWriteByte(ee, (CVMArrayOfByteICell*) dstArray, i, val);
            }
