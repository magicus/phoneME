...
public class TestXlet2Auto implements Xlet, KeyListener, MouseListener, FocusListener {
    ...
    public TestXlet2Auto() {
        System.out.println("Creating TestXlet2Auto:" + Thread.currentThread());
    ...
    public void destroyXlet(boolean b) {
        debugMessage("TestXlet2Auto.destoryXlet()");
        if (failed) {
           System.out.println("\nTest failed\n");
        }
    }
    ...
    public void mousePressed(MouseEvent e) {
        debugMessage("\nTestXlet2Auto-MousePressed:");
        debugMessage("   " + e.getSource() + " "  + Thread.currentThread());
        checkThreadGroup();
    }
    public void mouseReleased(MouseEvent e) {
        debugMessage("\nTestXlet2Auto-MouseReleased:");
        debugMessage("   " + e.getSource() + " "  + Thread.currentThread());
        checkThreadGroup();
    }
    public void mouseEntered(MouseEvent e) {
        debugMessage("\nTestXlet2Auto-MouseEntered:");
        debugMessage("   " + e.getSource() + " "  + Thread.currentThread());
        checkThreadGroup();
    }
    public void mouseExited(MouseEvent e) {
        debugMessage("\nTestXlet2Auto-MouseExited:"); 
        debugMessage("   " + e.getSource() + " "  + Thread.currentThread());
        checkThreadGroup();
    }
    public void mouseClicked(MouseEvent e) {
        debugMessage("\nTestXlet2Auto-MouseClicked:");
        debugMessage("   " + e.getSource() + " "  + Thread.currentThread());
        checkThreadGroup();
    }
