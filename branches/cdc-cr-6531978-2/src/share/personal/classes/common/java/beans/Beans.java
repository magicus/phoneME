...
public class Beans {
    ...
    public static Object instantiate(ClassLoader cls, String beanName) throws java.io.IOException, ClassNotFoundException {
		...
		stub = (AppletStub)new BeansAppletStub(
		            applet, context, codeBase, docBase);
		applet.setStub(stub);
...
class BeansAppletContext implements AppletContext {
    ...
    public void showDocument(URL url) {// We do nothing.
    }

    public void showDocument(URL url, String target) {// We do nothing.
    }

    public void showStatus(String status) {// We do nothing.
    }
}
...
class BeansAppletStub implements AppletStub {
    ...
    public void appletResize(int width, int height) {// we do nothing.
    }
}
