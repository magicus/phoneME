...
class FloatingDecimal{
	 ...
	 * NOTE: Can use more precise constants here. It costs no more.
	 */
    ...
    private int getChars(char[] result) {
        if (sun.misc.BuildFlags.qAssertsEnabled) 
           assert nDigits <= 19 : nDigits; // bound on size of nDigits
	int i = 0;
	...
	if(digits == infinity || digits == notANumber) {
	     ...
	     * and the latter I tried without success.
	     */
