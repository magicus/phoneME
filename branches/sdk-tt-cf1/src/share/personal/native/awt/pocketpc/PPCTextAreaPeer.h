/*
 * @(#)PPCTextAreaPeer.h	1.7 06/10/10
 *
 ...
 *
 */
#ifndef _WINCETEXT_AREA_PEER_H_
#define _WINCETEXT_AREA_PEER_H_
...
public:
    ...
    static AwtTextArea* Create(jobject self, jobject hParent);

    // Return the associated AWT peer object.
    INLINE jobject GetPeer() { 
	return m_peerObject; 
    }
    static int CountNewLines(jstring jStr, int maxlen);
};
