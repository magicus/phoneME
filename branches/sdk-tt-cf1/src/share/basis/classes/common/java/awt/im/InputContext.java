/*
 * @(#)InputContext.java	1.33 04/02/17
 *
 ...
 * programming language, using the interfaces in the {@link sun.awt.im.spi} package,
...
public class InputContext {
     ...
     * {@link sun.awt.im.spi.InputMethod#getLocale()} method returns null.
     *
     * <p>
     * Not all host operating systems provide API to determine the locale of
