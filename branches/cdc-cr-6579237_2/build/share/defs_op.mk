...
MIDP_JSROP_USE_FLAGS += USE_ABSTRACTIONS=$(USE_ABSTRACTIONS)
MIDP_JSROP_USE_FLAGS += ABSTRACTIONS_DIR=$(ABSTRACTIONS_DIR)
MIDP_JSROP_USE_FLAGS += PROJECT_ABSTRACTIONS_DIR=$(PROJECT_ABSTRACTIONS_DIR)
MIDP_JSROP_USE_FLAGS += ABSTRACTIONS_GENERATED_DIR:=$(call ABSPATH,$(ABSTRACTIONS_GENERATED_DIR))
...
LINKLIBS_CVM    += $(JAVACALL_LINKLIBS) -LIBPATH:$(JSROP_LIB_DIR)
endif
