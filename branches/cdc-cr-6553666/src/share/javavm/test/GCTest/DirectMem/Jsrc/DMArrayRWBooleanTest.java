/*
 * @(#)DMArrayRWBooleanTest.java	1.6 06/10/10
 *
...
public class DMArrayRWBooleanTest extends Thread {

   private boolean [] privateArray;
   public static Object lock;

   public DMArrayRWBooleanTest(int num) {
   ...
   public void run() {
      ...
      if(pass)
         System.out.println("PASS: DMArrayRWBooleanTest, Data written and read were same");
      else
         System.out.println("FAIL: DMArrayRWBooleanTest, Data written and read were not same");
   }
   ...
   public static void main(String args[]) {
      ...
      DMArrayRWBooleanTest.lock = lck;
      GcThread.lock = lck;

      GcThread gc = new GcThread();
      DMArrayRWBooleanTest test = new DMArrayRWBooleanTest(rd.nextInt(100));
