...
import java.util.*;
import sun.awt.peer.ChoicePeer;
...
public class Choice extends Component implements ItemSelectable {
    ...
    public void addNotify() {
        synchronized (getTreeLock()) {
            if (peer == null)
                peer = ((PeerBasedToolkit) getToolkit()).createChoice(this);
            super.addNotify();
        }
    }
