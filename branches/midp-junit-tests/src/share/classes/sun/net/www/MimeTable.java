...
public class MimeTable implements FileNameMap {
	...
	if (defaultInstance == null) {
		...
		public Object run() {
		    ...
		    java.net.URLConnection.setFileNameMap(defaultInstance);
		    return null;
		}
	    });
	}
	...
	i = fname.lastIndexOf('.');
	// NOTE: OS specific delimters appear here
	...
	// should handle embedded ';' and '|' and literal '"'
