/*
 * @(#)PPCRobotHelper.java	1.5 04/08/19
 *
...
public class PPCRobotHelper extends RobotHelper {
    GraphicsDevice ppcDevice;
    ...
    public PPCRobotHelper(GraphicsDevice graphicsDevice) throws AWTException {        
//	if (!(graphicsDevice instanceof PPCGraphicsDevice)) {
//	    throw new 
//		IllegalArgumentException("screen device is not on QT");
//	}
	ppcDevice = graphicsDevice;        
    }

    public BufferedImage getScreenImage(Rectangle screenRect) {
        
	GraphicsConfiguration graphicsConfiguration = 
	    ppcDevice.getDefaultConfiguration();
	...
	ColorModel cm = ppcDevice.getDefaultConfiguration().getColorModel(); 
