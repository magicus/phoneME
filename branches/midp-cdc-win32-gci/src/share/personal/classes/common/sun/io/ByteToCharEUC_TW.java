/*
 * @(#)ByteToCharEUC_TW.java	1.17 06/10/10
 *
...
public class ByteToCharEUC_TW extends ByteToCharConverter {
    ...
    private final byte G5 = 5;
    private final byte G6 = 6;
    ...
    private final char REPLACE_CHAR = '\uFFFD';
    ...
    public int convert(byte[] input, int inOff, int inEnd,
        ...
        while (byteOff < inEnd) {
            ...
            case G2:
                if (input[byteOff] == P2) {		// Plane 2
                    state = G3;
                } else if (input[byteOff] == P3) {	// Plane 3
                    state = G4;
                } else {				// Error
                    badInputLength = 2;
                    throw new MalformedInputException();
    ...
    private char convToUnicode(byte byte1, byte byte2, String table) {
        int	index;
