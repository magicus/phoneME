...
{ 
     ...
     */
    static native void setPrimitiveFieldValues(Object obj, 
     ...
     */
    static native void setObjectFieldValue(Object obj, long fieldID, 
     ...
     */
    static native Object allocateNewObject(Class aclass, Class initclass)
	...
	try {
	    obj = desc.isInstantiable() ? desc.newInstance() : null;
            ...
            throw new InvalidClassException(
                desc.forClass().getName(), "IllegalAccessException");
        } catch (InstantiationException e) {
            throw new InvalidClassException(
                desc.forClass().getName(), "InstantiationException");
	} catch (Exception ex) {
	    throw new InvalidClassException(
     ...
     */
    // TODO: remove once hotspot inlines Double.longBitsToDouble
     ...
     */
    // TODO: add full description of exception propagation algorithm?
