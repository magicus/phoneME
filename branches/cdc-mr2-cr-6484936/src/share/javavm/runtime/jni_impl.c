...
static struct JNINativeInterface *CVMmainJNIfuncsPtr = &CVMmainJNIfuncs;
...
{
    p_env->vector = CVMmainJNIfuncsPtr;
}
...
{
    return CVMmainJNIfuncsPtr;
}

#ifdef CVM_JVMTI
struct JNINativeInterface **
CVMjniGetJNINativeInterfacePtr()
{
    return &CVMmainJNIfuncsPtr;
}
#endif
