...
/*
 * Note that there are two versions of X509Factory, this subsetted
 * version for CDC/FP and another for the security optional package.
...
// CDC/FP X509CertificatePair subsetted out for space savings.
...
public class X509Factory extends CertificateFactorySpi {
	...
	if (is == null) {
	    ...
	    certCache.clear();
            // CDC/FP - X509CertificatePair has been subsetted
            // out to save space.
     ...
     */
    private Collection parseX509orPKCS7CRL(InputStream is)
