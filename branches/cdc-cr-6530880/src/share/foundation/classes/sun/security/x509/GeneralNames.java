/*
 * @(#)GeneralNames.java	1.18 06/10/10
 *
...
public class GeneralNames {
	...
	return (GeneralName)names.get(index);
    }
	...
	for (Iterator t = iterator(); t.hasNext(); ) {
	    GeneralName gn = (GeneralName)t.next();
            gn.encode(temp);
        }
