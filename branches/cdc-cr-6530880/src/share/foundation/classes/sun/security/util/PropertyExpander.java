/*
 * @(#)PropertyExpander.java	1.3 06/10/10
 *
...
// Note that there are two versions of this class, a subsetted
// version for CDC (which does not support the java.net.URI class)
// and this version in FP. Be sure you're editting the right one!
import java.net.URI;
