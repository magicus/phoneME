/*
 * @(#)X509CertPath.java	1.12 06/10/10
 *
...
public class X509CertPath extends CertPath {
     ...
     */
    private static final Collection encodingList;
	...
	for (Iterator t = this.certs.iterator(); t.hasNext(); ) {
	    Object obj = t.next();
     ...
     */
    private static List parsePKIPATH(InputStream is) 
	    throws CertificateException {
        List certList = null;
	...
	if (is == null) {
		...
		certList.add(certFac.generateCertificate
    ...
    private byte[] encodePKIPATH() throws CertificateEncodingException {
        ...
        ListIterator li = certs.listIterator(certs.size());
        try {
