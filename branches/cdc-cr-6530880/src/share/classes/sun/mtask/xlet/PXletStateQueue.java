/*
 * @(#)PXletStateQueue.java	1.6 06/10/10
 *
...
public class PXletStateQueue {
    EventQueueItem head = null;
    EventQueueItem tail = null;
    PXletManager manager;
    ...
    public PXletStateQueue(PXletManager xletManager) {
    ...
    // Note that dispatchEvents() should NOT be synchronized
    // since if handleRequest() blocks, new states cannot be queued
    //
