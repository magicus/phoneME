/*
 * @(#)img_output8_16_32.h	1.10 06/10/10
 *
 ...
 *
 * This implementation can store 8-bit, 16-bit, or 32-bit pixels into an
 * array of bytes, shorts, or longs such that the pixel for (srcX, srcY)
