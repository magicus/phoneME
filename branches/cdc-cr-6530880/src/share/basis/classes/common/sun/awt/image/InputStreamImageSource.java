/*
 * @(#)InputStreamImageSource.java	1.58 06/10/10
 *
							...
							ImageFetchable
{
	...
	cq.consumer.imageComplete(ImageConsumer.IMAGEERROR);
        ...
        // For basis only, comment the following if-block out as it
        // will bring in the sun.awt.image.ImageRepresentation which
        // is not used in the basis profile.
        /*
