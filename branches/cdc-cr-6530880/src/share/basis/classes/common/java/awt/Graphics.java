 ...
 * <h3>Compatibility</h3>
 * The Graphics class is compatible with the graphics class in
 * PersonalJava. It has modified behavior from JDK1.1.8, in that
 * its setXorMode may not have any effect.
 * 
 * @version 	1.54, 02/20/02
 * @author 	Sami Shaio
