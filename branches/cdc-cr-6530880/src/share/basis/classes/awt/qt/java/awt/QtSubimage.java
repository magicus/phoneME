...
class QtSubimage extends QtImage {
	private int originX, originY;
	private int subWidth, subHeight;

	QtSubimage(QtImage img, int x, int y, int width, int height) {
		super(img);
	...
	public Graphics getGraphics() {
		return new QtGraphics (this, originX, originY);
	}
