...
#include "dlAlloc_md.h"     /* SUN: Platform specific declarations */
...
/*
    ...
    programs.  This can be very effective in helping track down 
    dangling pointers.
...
/*
  INTERNAL_SSIZE_T is a signed version of the above, generally used
  to store the result of a subtraction of two INTERNAL_SIZE_T's
*/
