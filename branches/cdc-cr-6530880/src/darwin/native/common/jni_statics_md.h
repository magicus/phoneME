/*
 * @(#)jni_statics_md.h	1.10 06/10/10
 *
...
struct _CVMJNIStatics_md {
    DECL_JNI_STATIC_MD(jfieldID ,java_net_Inet6Address, ia6_ipaddressID);
    DECL_JNI_STATIC_MD(jmethodID,java_net_Inet4Address, ia4_ctrID);
    DECL_JNI_STATIC_MD(jmethodID,java_net_Inet6Address, ia6_ctrID);
