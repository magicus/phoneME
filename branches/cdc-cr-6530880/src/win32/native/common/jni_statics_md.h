...
struct _CVMJNIStatics_md {
    ...
    DECL_JNI_STATIC_MD(jclass,   java_net_PlainDatagramSocketImpl, ia4_class);
    DECL_JNI_STATIC_MD(jmethodID,java_net_PlainDatagramSocketImpl, ia4_ctor);
    ...
    DECL_JNI_STATIC_MD(jfieldID, java_io_Win32FileSystem, ids_path);
};
