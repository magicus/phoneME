...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /Zi /O2 /Oy- /I "./include" /I "../apr/include" /D "NDEBUG" /D "APR_DECLARE_STATIC" /D "API_DECLARE_STATIC" /D "WIN32" /D "_WINDOWS" /Fp"$(INTDIR)\apriconv.pch" /Yu"iconv.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\apriconv_src" /FD /c 
...
CPP=cl.exe
CPP_PROJ=/nologo /MDd /W3 /Zi /Od /I "./include" /I "../apr/include" /D "_DEBUG" /D "APR_DECLARE_STATIC" /D "API_DECLARE_STATIC" /D "WIN32" /D "_WINDOWS" /Fp"$(INTDIR)\apriconv.pch" /Yu"iconv.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\apriconv_src" /FD /EHsc /c 
...
CPP_SWITCHES=/nologo /MD /W3 /Zi /O2 /Oy- /I "./include" /I "../apr/include" /D "NDEBUG" /D "APR_DECLARE_STATIC" /D "API_DECLARE_STATIC" /D "WIN32" /D "_WINDOWS" /Fp"$(INTDIR)\apriconv.pch" /Yc"iconv.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\apriconv_src" /FD /c 
...
CPP_SWITCHES=/nologo /MDd /W3 /Zi /Od /I "./include" /I "../apr/include" /D "_DEBUG" /D "APR_DECLARE_STATIC" /D "API_DECLARE_STATIC" /D "WIN32" /D "_WINDOWS" /Fp"$(INTDIR)\apriconv.pch" /Yc"iconv.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\apriconv_src" /FD /EHsc /c 
