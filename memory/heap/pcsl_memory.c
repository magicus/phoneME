...
/**
 * An internal helper function used when PCSL_MEMORY_DEBUG is defined.
 * 
...
#else  /* PCSL_MEMORY_DEBUG is not defined */
...
#ifdef PCSL_MEMORY_DEBUG
void pcsl_mem_free_impl0(void *ptr, char *filename, int lineno) {
#else
