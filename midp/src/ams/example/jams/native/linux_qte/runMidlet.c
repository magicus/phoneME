...
main(int argc, char** commandlineArgs) {
    ...
    /*
     * -qcop is given when started by the QT Graphical Application
     * manager to allow data to be passed between QT if started by
     * a command line or exec it is not present.
     * This is not supported for now.
     */
    (void)midpRemoveCommandOption("-qcop", argv, &argc);
