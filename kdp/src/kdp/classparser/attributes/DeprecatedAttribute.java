...
/**
 * Encapsulates the Deprecated attribute of a Java class file.
 *
 * This class has never been thoroughly tested.
 *
 *
 * Revision History
 *   $Log: DeprecatedAttribute.java,v $
...
public class DeprecatedAttribute extends Attribute
{
    ...
    /**
     * Constructor.  Reads the DeprecatedAttribute attribute from
     * the class file.
     *
     ...
     */
    public DeprecatedAttribute (DataInputStream iStream,
    ...
    /**
     * Returns the DeprecatedAttribute attribute in a nice easy to
