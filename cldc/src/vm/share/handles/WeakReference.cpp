...
//  ic().verify_instance_field("next", "Ljava/lang/ref/Reference;", next_offset());
//  ic().verify_instance_field("reference_queue", "Ljava/lang/ReferenceQueue;", reference_queue_offset());
}
#endif // !PRODUCT
