...
public abstract class InputStream {
    ...
    private static final int SKIP_BLOCK_SIZE = 4096;

    private static final byte tmp_buf[] = new byte[SKIP_BLOCK_SIZE];
	...
	while (bytesToReadTotal > 0) {
		...
		bytesToReadTotal -= readBytes;
	}
	return n - bytesToReadTotal;
    }
