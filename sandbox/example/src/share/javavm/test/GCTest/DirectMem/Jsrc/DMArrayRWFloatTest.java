/*
 * @(#)DMArrayRWFloatTest.java	1.6 06/10/10
 *
...
public class DMArrayRWFloatTest extends Thread {

   private float [] privateArray;
   public static Object lock;

   public DMArrayRWFloatTest(int num) {
   ...
   public void run() {
      ...
      if(pass)
         System.out.println("PASS: DMArrayRWFloatTest, Data written and read were same");
      else
         System.out.println("FAIL: DMArrayRWFloatTest, Data written and read were not same");
   }
   ...
   public static void main(String args[]) {
      ...
      DMArrayRWFloatTest.lock = lck;
      GcThread.lock = lck;

      GcThread gc = new GcThread();
      DMArrayRWFloatTest test = new DMArrayRWFloatTest(rd.nextInt(100));
