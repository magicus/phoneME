...
build-unittests:: $(J2ME_CLASSLIB)
	...
	$(AT)(cd $(JUMP_DIR); $(CVM_ANT) $(BUILD_UNITTEST_ANT_OPTIONS) -f build/build.xml build-unittests)

run-unittests::
	$(AT)echo "Running jump unit-tests ..."
	$(AT)(cd $(JUMP_DIR); $(CVM_ANT) $(RUN_UNITTEST_ANT_OPTIONS) -f build/build.xml run-unittests)
