...
ifeq ($(CVM_NATIVE_PROCESSES),)
$(CVM_NATIVE_PROCESS_DIR)/$(CVM_NATIVE_PROCESS_LST): $(CVM_NATIVE_PROCESS_DIR)
	$(AT) echo creating empty $@ ...
	$(AT) echo "/* This file is auto-generated by the CVM build process."> $@
	$(AT) echo "   Do not edit. */" >> $@
	$(AT) echo "#include \"native_process.h\"" >> $@
	$(AT) echo "ProcessRec nativeProcessList[] = {" >> $@
	$(AT) echo "{(void*)0, (void*)0}};" >> $@
else
$(CVM_NATIVE_PROCESS_DIR)/$(CVM_NATIVE_PROCESS_LST): $(CVM_NATIVE_PROCESS_DIR)
	$(AT) echo creating $@ ...
	$(AT) echo "/* This file is auto-generated by the CVM build process."> $@
	$(AT) echo "Do not edit. */" >> $@
	$(AT) echo "#include \"native_process.h\"" >> $@
	$(AT) for p in $(CVM_NATIVE_PROCESSES); do \
              echo "void $${p}(int argc, char **argv);" >> $@; \
          done
	$(AT) echo "ProcessRec nativeProcessList[] = {" >> $@
	$(AT) for p in $(CVM_NATIVE_PROCESSES); do \
              echo "{\"$${p}\", $${p} }," >> $@; \
