...
ifeq ($(IsTarget), true)
OUTPUT_FILES = $(NATIVES_TABLE) $(JVM_LIB) $(JVMX_LIB) $(JVMTEST_LIB)

ifneq ($(GENERATE_EXECUTABLE), false)
OUTPUT_FILES += $(JVM_EXE)
...
$(DIST_LIB_DIR)/$(JVM_MAK_NAME)::
	...
	$(A)echo "JVM_ENABLE_API_EXTENSIONS = $(ENABLE_API_EXTENSIONS)"   >> $@
