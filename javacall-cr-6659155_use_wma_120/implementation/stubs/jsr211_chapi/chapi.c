 ...
 */
javacall_result javacall_chapi_enum_handlers(int* pos_id,
...
javacall_result javacall_chapi_enum_handlers_by_suffix(
            javacall_const_utf16_string suffix, int* pos_id,
...
javacall_result javacall_chapi_enum_handlers_by_type(
            javacall_const_utf16_string content_type, int* pos_id,
    /*OUT*/ javacall_utf16*  handler_id_out, int* length) {
    return JAVACALL_NOT_IMPLEMENTED;
}
...
javacall_result javacall_chapi_enum_handlers_by_action(
            javacall_const_utf16_string action, int* pos_id,
    /*OUT*/ javacall_utf16*  handler_id_out, int* length) {
    return JAVACALL_NOT_IMPLEMENTED;
}
...
javacall_result javacall_chapi_enum_handlers_by_prefix(
            javacall_const_utf16_string id, int* pos_id,
    /*OUT*/ javacall_utf16* handler_id_out, int* length) {
    return JAVACALL_NOT_IMPLEMENTED;
}
...
javacall_result javacall_chapi_enum_suffixes(
            javacall_const_utf16_string content_handler_id, int* pos_id,
...
javacall_result javacall_chapi_enum_types(
            javacall_const_utf16_string content_handler_id,
    /*OUT*/ int* pos_id, javacall_utf16* type_out, int* length) {
    return JAVACALL_NOT_IMPLEMENTED;
}
...
javacall_result javacall_chapi_enum_actions(
            javacall_const_utf16_string content_handler_id,
    /*OUT*/ int* pos_id, javacall_utf16* action_out, int* length) {
    return JAVACALL_NOT_IMPLEMENTED;
}
...
javacall_result javacall_chapi_enum_action_locales(
            javacall_const_utf16_string content_handler_id,
    /*OUT*/ int* pos_id, javacall_utf16* locale_out, int* length) {
    return JAVACALL_NOT_IMPLEMENTED;
}
...
javacall_result javacall_chapi_get_local_action_name(
    ...
    javacall_utf16* local_action_out, int* length) {
    return JAVACALL_NOT_IMPLEMENTED;
}
...
/**
 * Ask NAMS to launch specified MIDlet. <BR>
...
/**
 * Send invocation request to platform handler. <BR>
...
/**
 * Receive invocation request from platform. <BR>
