...
public interface PermissionCallback {
     ...
     * </p>
     *
     * @param permissionName unique name of the permission to check for,
     * cannot be <code>null</code>
     *
     * @param resource string to insert into the question,
     * can be <code>null</code>
     *
     * @param extraValue string to insert into the question,
     * can be <code>null</code>
     *
     * @exception SecurityException if the permission is not allowed
     */
