...
/* 
 * A pre-generated Stub class for CDCAmsIxcRegistry.
 * Clinet VMs use this class to talk with master IxcRegistry.
 */

public final class CDCAmsAppManagerStub extends StubObject 
                                  implements CDCAmsRemoteInterface {
    ...
    public CDCAmsAppManagerStub(XletContext context) {
    ...
    public Remote lookupWithXletID(String name, String xletID)
        throws RemoteException, NotBoundException, AccessException {

        try {
           Object r = com_sun_xlet_execute(getMethodID("lookupWithXletID"), new Object[] { name, xletID });
           return (Remote) r;
        } catch (RemoteException re) { 
           throw re; 
        } catch (NotBoundException nbe) {
    ...
    public void notifyObjectImport(String importingXletID, Remote obj) {
        try {
           com_sun_xlet_execute(getMethodID("notifyObjectImport"),
                                new Object[] { importingXletID, obj });
        } catch (Exception e) {
           e.printStackTrace();
        }
    }
