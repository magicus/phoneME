/*
 * @(#)DMFieldRWIntTest.java	1.6 06/10/10
 *
...
public class DMFieldRWIntTest extends Thread {
   ...
   public void run () {
      ...
      if(pass)
         System.out.println("PASS: DMFieldRWIntTest, Data written and read were same");
      else
         System.out.println("FAIL: DMFieldRWIntTest, Data written and read were not same");
   ...
   public static void main(String args[]) {
      ...
      DMFieldRWIntTest test = new DMFieldRWIntTest();
