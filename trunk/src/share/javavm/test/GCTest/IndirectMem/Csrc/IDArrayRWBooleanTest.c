/*
 * @(#)IDArrayRWBooleanTest.c	1.6 06/10/10
 *
...
#include <stdio.h>
#include "IDArrayRWBooleanTest.h"


JNIEXPORT void JNICALL
Java_IDArrayRWBooleanTest_nSetArray(JNIEnv *env, jobject obj, 
   ...
   CVMD_gcUnsafeExec( ee, {
      CVMD_gcSafeExec(ee, {
         ...
         for(i=0; i<arrayLength; i++) {
            CVMID_arrayReadBoolean(ee, (CVMArrayOfBooleanICell*) srcArray, i, val);
            CVMID_arrayWriteBoolean(ee, (CVMArrayOfBooleanICell*) dstArray, i, val);
         }
