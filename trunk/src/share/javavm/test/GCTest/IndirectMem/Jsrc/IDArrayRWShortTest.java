/*
 * @(#)IDArrayRWShortTest.java	1.6 06/10/10
 *
...
public class IDArrayRWShortTest extends Thread {

   private short [] privateArray;

   public IDArrayRWShortTest(int num) {
   ...
   public void run() {
      ...
      if(pass)
         System.out.println("PASS: IDArrayRWShortTest, Data written and read were same");
      else
         System.out.println("FAIL: IDArrayRWShortTest, Data written and read were not same");
   }
   ...
   public static void main(String args[]) {
      ...
      IDArrayRWShortTest test = new IDArrayRWShortTest(rd.nextInt(100));
