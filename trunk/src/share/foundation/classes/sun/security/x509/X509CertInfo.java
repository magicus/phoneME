...
public class X509CertInfo implements CertAttrSet {
    ...
    static {
        map.put(VERSION, new Integer(ATTR_VERSION));
        map.put(SERIAL_NUMBER, new Integer(ATTR_SERIAL));
        map.put(ALGORITHM_ID, new Integer(ATTR_ALGORITHM));
        map.put(ISSUER, new Integer(ATTR_ISSUER));
        map.put(VALIDITY, new Integer(ATTR_VALIDITY));
        map.put(SUBJECT, new Integer(ATTR_SUBJECT));
        map.put(KEY, new Integer(ATTR_KEY));
        map.put(ISSUER_ID, new Integer(ATTR_ISSUER_ID));
        map.put(SUBJECT_ID, new Integer(ATTR_SUBJECT_ID));
        map.put(EXTENSIONS, new Integer(ATTR_EXTENSIONS));
    }
    ...
    /*
     * Verify if X.509 V3 Certificate was compliant with RFC 2459
     */
    private void verifyCert(CertificateSubjectName subject, 
	CertificateExtensions extensions) throws CertificateParsingException, IOException {
