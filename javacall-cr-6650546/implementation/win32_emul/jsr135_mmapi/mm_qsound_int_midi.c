 ...
 * 
 */
static javacall_result interactive_midi_get_time(javacall_handle handle, long *ms)
{
    *ms = -1;
    return JAVACALL_OK;
}
 ...
 * 
 */
static javacall_result interactive_midi_set_time(javacall_handle handle, long *ms)
{
    *ms = -1;
    return JAVACALL_OK;
}
 ...
 * 
 */
static javacall_result interactive_midi_get_duration(javacall_handle handle, long* ms)
{
    *ms = -1;
    return JAVACALL_OK;
}
...
javacall_result interactive_midi_short_midi_event(javacall_handle handle, 
                                                  long type, long data1, 
                                                  long data2)
{
    javacall_result ret = JAVACALL_FAIL;
    IMIDIControl* pIM = (IMIDIControl*)handle;

    if (pIM) {
        JSR135ErrorCode err = mQ135_MIDI_ShortMidiEvent(pIM, type, data1, data2);
        if (err == JSR135Error_No_Error)
            ret = JAVACALL_OK;
    }
 ...
 */
static javacall_result interactive_midi_get_volume(javacall_handle handle, long* level) {
    *level = 0;
    return JAVACALL_OK;
}
 ...
 */
static javacall_result interactive_midi_set_volume(javacall_handle handle, long* level) {
    *level = 0;
    return JAVACALL_OK;
}
 ...
 */
static javacall_result interactive_midi_is_mute(javacall_handle handle, javacall_bool* mute) {
    *mute = JAVACALL_FALSE;
    return JAVACALL_OK;
}
...
media_interface g_qsound_interactive_midi_itf = {
    &_basic_itf,
