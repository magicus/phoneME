...
public class Gen_Writer extends StreamWriter {
   /** Saved encoding string from construction. */
     ...
     */
    Gen_Writer(String inp_enc) throws ClassNotFoundException {
     ...
     * @param open_enc the character encoding for the output stream
     * @return Writer instance for converted characters
     * @throws UnsupportedEncodingException if encoding is not supported
     */
    public Writer open(OutputStream out, String open_enc) 
