...
class MMEventListener implements EventListener {
    ...
    private static final int EVENT_MEDIA_GET_MEDIA_TIME_FINISHED =  7;
    private static final int EVENT_MEDIA_SET_MEDIA_TIME_FINISHED =  8;
    private static final int EVENT_MEDIA_DATA_REQUEST            =  9;
    private static final int EVENT_MEDIA_LENGTH_REQUEST          = 10;
    private static final int EVENT_MEDIA_DEVICE_AVAILABLE        = 11;
    private static final int EVENT_MEDIA_DEVICE_UNAVAILABLE      = 12;
    private static final int EVENT_MEDIA_ERROR                   = 13;
    private static final int EVENT_MEDIA_END_OF_MEDIA            = 14;
    private static final int EVENT_MEDIA_DURATION_UPDATED        = 15;
    private static final int EVENT_MEDIA_BUFFERING_STARTED       = 16;
    private static final int EVENT_MEDIA_BUFFERING_STOPPED       = 17;
    private static final int EVENT_MEDIA_RECORD_ERROR            = 18;
    private static final int EVENT_MEDIA_RECORD_SIZE_LIMIT       = 19;
    private static final int EVENT_MEDIA_VOLUME_CHANGED          = 20;
    private static final int EVENT_MEDIA_SYSTEM_VOLUME_CHANGED   = 21;
    private static final int EVENT_MEDIA_SNAPSHOT_FINISHED       = 22;
