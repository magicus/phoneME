...
class RecordEnumerationImpl implements RecordEnumeration {
    ...
    javax.microedition.rms.RecordEnumeration re;

    RecordEnumerationImpl(javax.microedition.rms.RecordEnumeration re) {
        this.re = re;
    }
    ...
    public int nextRecordId() throws InvalidRecordIDException {
         ...
         } catch (javax.microedition.rms.InvalidRecordIDException ire) {
             throw new InvalidRecordIDException(ire.getMessage());
         }
    };
