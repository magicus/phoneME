...
class AppBundleProxy extends AppProxy {
                          ...
                          String classname, String authority, Hashtable appmap) throws ClassNotFoundException
    {
        ...
        if (Logger.LOGGER != null)
        	Logger.LOGGER.println("AppBundleProxy created: installer = " + this.installer + 
    ...
    AppProxy forClass(String classname) throws ClassNotFoundException
    {
	    ...
	    synchronized (mutex) {
            ...
            if (curr == null) {
		        ...
		        if (Logger.LOGGER != null)
		        	Logger.LOGGER.println("AppBundleProxy for class '" + classname + "' created: " + curr);
	        }
	    }
	    return curr;
    }
    ...
    {
    	if(Logger.LOGGER != null) 
    		Logger.LOGGER.println("AppBundleProxy.verifyApplication: installer = " + 
    				installer );
	    try {
