...
class RegisterAllocator {
 ...
 public:
  ...
  //CSE
#if ENABLE_CSE 
  static inline void init_notation() {
  ...
  static void move_notation(const Register reg, const Register new_reg) {
    _register_notation_table[new_reg].notation = 
       _register_notation_table[reg].notation;
    _register_notation_table[new_reg].locals = 
       _register_notation_table[reg].locals;
    _register_notation_table[new_reg].constants = 
       _register_notation_table[reg].constants;
    _register_notation_table[new_reg].type = 
       _register_notation_table[reg].type;
    _register_notation_table[new_reg].array_element_type= 
       _register_notation_table[reg].array_element_type;
    jint mask = (1<<new_reg);
    _notation_map |= mask;
    if ((_status_checked & (1<<reg) ) != 0 ) {
  ...
  static inline void set_check_status(const Register reg, const jint count) {
  ...
  static inline void clear_notation(const Register reg) {
  ...
  static inline void clear_notation(const jint bitmap) {
  ...
  static void kill_locals(const jint local_index);
  static void kill_constant(const jint constant_index);
  static void kill_array_type(const jint array_element_type);
 ...
 private:
  ...
  static jint locals_depended;
  static jint constants_depended;
