...
PRODUCT_CONST Bytecodes::BytecodeData Bytecodes::data[] = {
  def(nop                       , 1, "b"    , 0, ""      , None),
  def(aconst_null               , 1, "b"    , 0, ""      , ExprStart),
  def(iconst_m1                 , 1, "b"    , 0, ""      , ExprStart),
  def(iconst_0                  , 1, "b"    , 0, ""      , ExprStart),
  def(iconst_1                  , 1, "b"    , 0, ""      , ExprStart),
  def(iconst_2                  , 1, "b"    , 0, ""      , ExprStart),
  def(iconst_3                  , 1, "b"    , 0, ""      , ExprStart),
  def(iconst_4                  , 1, "b"    , 0, ""      , ExprStart),
  def(iconst_5                  , 1, "b"    , 0, ""      , ExprStart),
 ...
 fdef(dconst_1                  , 1, "b"    , 0, ""      , None),
  def(bipush                    , 2, "bc"   , 0, ""      , ExprStart),
  def(sipush                    , 3, "bcc"  , 0, ""      , ExprStart),
  def(ldc                       , 2, "bi"   , 0, ""      , ExprStart),
  def(ldc_w                     , 3, "bii"  , 0, ""      , ExprStart),
  def(ldc2_w                    , 3, "bii"  , 0, ""      , None),
  def(iload                     , 2, "bi"   , 4, "wbii"  , ExprStart),
  def(lload                     , 2, "bi"   , 4, "wbii"  , None),
 fdef(fload                     , 2, "bi"   , 4, "wbii"  , None),
 fdef(dload                     , 2, "bi"   , 4, "wbii"  , None),
  def(aload                     , 2, "bi"   , 4, "wbii"  , ExprStart),
  def(iload_0                   , 1, "b"    , 0, ""      , ExprStart),
  def(iload_1                   , 1, "b"    , 0, ""      , ExprStart),
  def(iload_2                   , 1, "b"    , 0, ""      , ExprStart),
  def(iload_3                   , 1, "b"    , 0, ""      , ExprStart),
  def(lload_0                   , 1, "b"    , 0, ""      , ExprStart),
  def(lload_1                   , 1, "b"    , 0, ""      , ExprStart),
  def(lload_2                   , 1, "b"    , 0, ""      , ExprStart),
  def(lload_3                   , 1, "b"    , 0, ""      , ExprStart),
 ...
 fdef(dload_3                   , 1, "b"    , 0, ""      , None),
  def(aload_0                   , 1, "b"    , 0, ""      , ExprStart),
  def(aload_1                   , 1, "b"    , 0, ""      , ExprStart),
  def(aload_2                   , 1, "b"    , 0, ""      , ExprStart),
  def(aload_3                   , 1, "b"    , 0, ""      , ExprStart),
  def(iaload                    , 1, "b"    , 0, ""      , NullCheck | Expr),
  def(laload                    , 1, "b"    , 0, ""      , NullCheck),
 fdef(faload                    , 1, "b"    , 0, ""      , NullCheck),
 fdef(daload                    , 1, "b"    , 0, ""      , NullCheck),
  def(aaload                    , 1, "b"    , 0, ""      , NullCheck | Expr),
  def(baload                    , 1, "b"    , 0, ""      , NullCheck | Expr),
  def(caload                    , 1, "b"    , 0, ""      , NullCheck | Expr),
  def(saload                    , 1, "b"    , 0, ""      , NullCheck | Expr),
 ...
 fdef(dreturn                   , 1, "b"    , 0, ""      , NoFallThru),
  ...
  def(getstatic                 , 3, "bjj"  , 0, ""      , Exceptions | ExprStart),
  def(putstatic                 , 3, "bjj"  , 0, ""      , Exceptions),
  def(getfield                  , 3, "bjj"  , 0, ""      , NullCheck | Expr),
  ...
  def(new                       , 3, "bii"  , 0, ""      , Exceptions | NoPatching | NeedsFrameExARM | CanRedo),
  def(newarray                  , 2, "bc"   , 0, ""      , Exceptions | NoPatching | CanRedo),
  def(anewarray                 , 3, "bii"  , 0, ""      , Exceptions | NoPatching | NeedsFrameExARM | CanRedo),
  def(arraylength               , 1, "b"    , 0, ""      , NullCheck),
  def(athrow                    , 1, "b"    , 0, ""      , NoFallThru | NullCheck | NoInlining),
  def(checkcast                 , 3, "bii"  , 0, ""      , Exceptions | NoPatching | NoInlining | Expr),
  def(instanceof                , 3, "bii"  , 0, ""      , Exceptions | NoPatching | NeedsFrameExARM | Expr),
  ...
  def(fast_1_ldc                , 2, "bi"   , 0, ""      , ExprStart),
  def(fast_1_ldc_w              , 3, "bii"  , 0, ""      , ExprStart),
  ...
  def(fast_1_getstatic          , 3, "bjj"  , 0, ""      , Exceptions | ExprStart),
  def(fast_2_getstatic          , 3, "bjj"  , 0, ""      , Exceptions),
 ...
 fdef(fast_dputfield            , 3, "bjj"  , 0, ""      , NullCheck),
  ...
  def(fast_bgetfield            , 3, "bjj"  , 0, ""      , NullCheck | Expr),
  def(fast_sgetfield            , 3, "bjj"  , 0, ""      , NullCheck | Expr),
  def(fast_igetfield            , 3, "bjj"  , 0, ""      , NullCheck | Expr),
  def(fast_lgetfield            , 3, "bjj"  , 0, ""      , NullCheck | Expr),
 fdef(fast_fgetfield            , 3, "bjj"  , 0, ""      , NullCheck),
 fdef(fast_dgetfield            , 3, "bjj"  , 0, ""      , NullCheck),
  def(fast_agetfield            , 3, "bjj"  , 0, ""      , NullCheck | Expr),
  def(fast_cgetfield            , 3, "bjj"  , 0, ""      , NullCheck | Expr),
  ...
  def(fast_new                  , 3, "bii"  , 0, ""      , Exceptions | NoPatching | NeedsFrameExARM | CanRedo),
  def(fast_anewarray            , 3, "bii"  , 0, ""      , Exceptions | NoPatching | NeedsFrameExARM | CanRedo),
  def(fast_checkcast            , 3, "bii"  , 0, ""      , Exceptions | NoPatching | NoInlining | Expr),
  def(fast_instanceof           , 3, "bii"  , 0, ""      , Exceptions | NoPatching | NeedsFrameExARM | Expr),
  def(fast_igetfield_1          , 2, "bi"   , 0, ""      , NullCheck | Expr),
  def(fast_agetfield_1          , 2, "bi"   , 0, ""      , NullCheck | Expr),
  def(aload_0_fast_agetfield_1  , 2, "bi"   , 0, ""      , NullCheck | ExprStart),
  def(aload_0_fast_igetfield_1  , 2, "bi"   , 0, ""      , NullCheck | ExprStart),
  def(pop_and_npe_if_null       , 1, "b"    , 0, ""      , NullCheck),
#if !ENABLE_CPU_VARIANT
  def(init_static_array         , 0, ""     , 0, ""      , None),
  def(aload_0_fast_agetfield_4  , 1, "b"    , 0, ""      , Exceptions | ExprStart),
  def(aload_0_fast_igetfield_4  , 1, "b"    , 0, ""      , Exceptions | ExprStart),
  def(aload_0_fast_agetfield_8  , 1, "b"    , 0, ""      , Exceptions | ExprStart),
  def(aload_0_fast_igetfield_8  , 1, "b"    , 0, ""      , Exceptions | ExprStart),
 ...
 fdef(dstore_safe               , 2, "bi"   , 4, "wbii"  , None),
  ...
  def(fast_init_1_getstatic     , 3, "bjj"  , 0, ""      , Exceptions | ExprStart),
  def(fast_init_2_getstatic     , 3, "bjj"  , 0, ""      , Exceptions),
  def(fast_init_invokestatic    , 3, "bjj"  , 0, ""      , Exceptions | NoPatching),
  def(fast_init_new             , 3, "bii"  , 0, ""      , Exceptions | NoPatching | CanRedo),
