...
PRODUCT_CONST Bytecodes::BytecodeData Bytecodes::data[] = {
 ...
 fdef(dload_3                   , 1, "b"    , 0, ""      , None),
  ...
  def(iaload                    , 1, "b"    , 0, ""      , NullCheck),
  def(laload                    , 1, "b"    , 0, ""      , NullCheck),
 fdef(faload                    , 1, "b"    , 0, ""      , NullCheck),
 fdef(daload                    , 1, "b"    , 0, ""      , NullCheck),
  def(aaload                    , 1, "b"    , 0, ""      , NullCheck),
  def(baload                    , 1, "b"    , 0, ""      , NullCheck),
  def(caload                    , 1, "b"    , 0, ""      , NullCheck),
  def(saload                    , 1, "b"    , 0, ""      , NullCheck),
 ...
 fdef(dreturn                   , 1, "b"    , 0, ""      , NoFallThru),
  ...
  def(getstatic                 , 3, "bjj"  , 0, ""      , Exceptions),
  def(putstatic                 , 3, "bjj"  , 0, ""      , Exceptions),
  def(getfield                  , 3, "bjj"  , 0, ""      , NullCheck),
  ...
  def(fast_1_getstatic          , 3, "bjj"  , 0, ""      , Exceptions),
 ...
 fdef(fast_dputfield            , 3, "bjj"  , 0, ""      , NullCheck),
  ...
  def(fast_bgetfield            , 3, "bjj"  , 0, ""      , NullCheck),
  def(fast_sgetfield            , 3, "bjj"  , 0, ""      , NullCheck),
  def(fast_igetfield            , 3, "bjj"  , 0, ""      , NullCheck),
  def(fast_lgetfield            , 3, "bjj"  , 0, ""      , NullCheck),
 fdef(fast_fgetfield            , 3, "bjj"  , 0, ""      , NullCheck),
 fdef(fast_dgetfield            , 3, "bjj"  , 0, ""      , NullCheck),
  def(fast_agetfield            , 3, "bjj"  , 0, ""      , NullCheck),
  def(fast_cgetfield            , 3, "bjj"  , 0, ""      , NullCheck),
  ...
  def(fast_igetfield_1          , 2, "bi"   , 0, ""      , NullCheck),
  def(fast_agetfield_1          , 2, "bi"   , 0, ""      , NullCheck),
  def(aload_0_fast_agetfield_1  , 2, "bi"   , 0, ""      , NullCheck),
  def(aload_0_fast_igetfield_1  , 2, "bi"   , 0, ""      , NullCheck),
  def(pop_and_npe_if_null       , 1, "b"    , 0, ""      , NullCheck),
#if !ENABLE_CPU_VARIANT
  def(init_static_array         , 0, ""     , 0, ""      , None),
  def(aload_0_fast_agetfield_4  , 1, "b"    , 0, ""      , Exceptions),
  def(aload_0_fast_igetfield_4  , 1, "b"    , 0, ""      , Exceptions),
  def(aload_0_fast_agetfield_8  , 1, "b"    , 0, ""      , Exceptions),
  def(aload_0_fast_igetfield_8  , 1, "b"    , 0, ""      , Exceptions),
