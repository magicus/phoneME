...
//
// ENABLE_ALLOCATION_REDO               0,0 Enable support for memory 
//                                          allocation redo, see 
...
// USE_SOFT_REFERENCES
//
#define USE_SOFT_REFERENCES ENABLE_EXTENDED_API

#if ENABLE_INLINE
#  define USE_COMPILED_METHOD_DEPENDENCIES 1
#else
#  define USE_COMPILED_METHOD_DEPENDENCIES 0
#endif
