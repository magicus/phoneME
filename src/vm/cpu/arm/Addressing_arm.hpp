...
class MemoryAddress: public GenericAddress {
 ...
 public:
  ...
  Assembler::Address2 lo_address_2()  { 
    return address_2_for(lo_offset());
  }
  Assembler::Address3 lo_address_3()  { 
    return address_3_for(lo_offset());
  }
  Assembler::Address2 hi_address_2()  { 
