...
public class ServiceRegistryClient {
	...
	* ust that, else the agreement is to use Executive process id + 1.
	* 
	* FIXME: this port number setup should go away once IXC is on messeging.
	*/
       String port = (String) JUMPModulesConfig.getProperties().get("jump.serviceregistry.port");

       int portNumber = (port == null) ? 
	     JUMPIsolateProcess.getInstance().getExecutiveProcess().getProcessId() + 1:
