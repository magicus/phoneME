...
/**
 * <code>MultimediaModuleFactoryImpl</code> is a factory for 
 * <code>MultimediaModuleImpl</code>.
 */
public class MultimediaModuleFactoryImpl extends JUMPModuleFactory {
    /** The only instance of Multimedia module. */
    ...
    public void load(Map config) {
        try {
            Object o = Class.forName("com.sun.jumpimpl.module.multimedia.MultimediaModuleImpl")
                .newInstance();
            MODULE = (JUMPModule)o;
            MODULE.load(config);
