/*
 * @(#)DMArrayRWRefTest.java	1.6 06/10/10
 *
...
public class DMArrayRWRefTest extends Thread {

   private String [] privateArray;
   public static Object lock;

   public DMArrayRWRefTest(int num) {
   ...
   public void setArray(String [] strArray) {
	this.nSetArray(this.privateArray, strArray, getArrayLength());
   }
   ...
   public void run() {
      ...
      if(pass)
         System.out.println("PASS: DMArrayRWRefTest, Data written and read were same");
      else
         System.out.println("FAIL: DMArrayRWRefTest, Data written and read were not same");
   }
   ...
   public static void main(String args[]) {
      ...
      DMArrayRWRefTest.lock = lck;
      GcThread.lock = lck;

      GcThread gc = new GcThread();
      DMArrayRWRefTest test = new DMArrayRWRefTest(rd.nextInt(100));
