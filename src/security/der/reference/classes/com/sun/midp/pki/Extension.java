...
public class Extension {
    ...
    public boolean equals(Object other) {
        ...
        if (extensionValue == null && otherExt.extensionValue == null) {
            return true;
        }
        if ((extensionValue == null && otherExt.extensionValue != null) ||
                (extensionValue != null && otherExt.extensionValue == null)) {
            return false;
        }
        if (extensionValue.length != otherExt.extensionValue.length) {
            return false;
        }

        for (int i = 0; i < extensionValue.length; i++) {
            if (extensionValue[i] != otherExt.extensionValue[i]) {
                return false;
            }
        }
