...
public class AlgorithmId {
    ...
    private static ObjectIdentifier oid(int v1, int v2, int v3,
        ...
        return ObjectIdentifier.newInternal(new int[] {v1, v2, v3, v4, v5, v6});
    }

    private static ObjectIdentifier oid(int v1, int v2, int v3,
                                        int v4, int v5, int v6, int v7) {
        return ObjectIdentifier.newInternal(
                new int[] {v1, v2, v3, v4, v5, v6, v7});
    }
