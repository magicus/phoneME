...
public final class AmsPermission extends Permission
{
    /**
     * Creates a new AmsPermission object with 
     * the specified name.
     * @param name the name of the AmsPermission
     */
    public AmsPermission(String name)
    {
        super(name);
    }
    ...
    {
        return (p instanceof AmsPermission);
    }
    ...
    {
        return (o instanceof AmsPermission);
    }

    /**
     * Returns the canonical string representation of the
     * actions, which currently is the empty string, because
     * there are no actions for AmsPermission.
     *
