...
public final class TrustedAppPermission extends Permission
{

    /**
     * Creates a new TrustedAppPermission object with 
     * the specified name.
     *
     * @param name the name of the TrustedAppPermission
     */
    public TrustedAppPermission(String name)
    {
	super(name);
    }
    ...
    {
	return (p instanceof TrustedAppPermission);
    }
    ...
    {
	return (o instanceof TrustedAppPermission);
    }

    /**
     * Returns the canonical string representation of the
     * actions, which currently is the empty string, because
     * there are no actions for TrustedAppPermission.
     *
