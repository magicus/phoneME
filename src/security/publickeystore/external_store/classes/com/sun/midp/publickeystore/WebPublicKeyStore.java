...
public class WebPublicKeyStore extends PublicKeyStore
    ...
    public static void loadCertificateAuthorities() {
        ...
        System.out.println("=========== loadCertificateAuthorities start =======");
        if (trustedKeyStore != null) {
            return;
        }
           
        try {
            ks = new com.sun.midp.publickeystore.WebPublicKeyStore(in);
            System.out.println("loadCertificateAuthorities: exc not thrown if can see thisline");
            System.out.println("========= loadCertificateAuthorities end ======");
        } catch (Exception e) {
