...
/**
 * Gets the event queue associated with an queueId.
 *
 * @param queueId ID of an queue or 0 for SVM mode
 *
 */
static EventQueue* getEventQueueById(jint queueId) {
    /*
     ...
     * more entry in gsEventQueues[], thus the condition bellow is
