...
public interface VirtualKeyboard {
    ...
    /*Keyboard types*/
    static final String LOWER_ALPHABETIC_KEYBOARD = "lower_alpha";
    static final String UPPER_ALPHABETIC_KEYBOARD = "upper_alpha";
    static final String NUMERIC_KEYBOARD = "numeric";
    static final String SYBOLIC_KEYBOARD = "symbol";
    static final String GAME_KEYBOARD = "game";
     ...
     */
    void resize(double kshrinkX, double kshrinkY);
     ...
     */
    boolean pointerInput(int type, int x, int y);

    /**
     * Change type of keyboard
     * @param newType type of new shown keyboard
     */
    void changeKeyboard(String newType);
