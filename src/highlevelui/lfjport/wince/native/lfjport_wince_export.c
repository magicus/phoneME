...
jboolean lfjport_reverse_orientation(int hardwareId) {
  (void)hardwareId;
  return winceapp_reverse_orientation();
}
...
void lfjport_handle_clamshell_event() {
    winceapp_hadle_clamshell_event();
}
...
jboolean lfjport_get_reverse_orientation(int hardwareId) {
  (void)hardwareId;
    return winceapp_get_reverse_orientation();
}
...
int lfjport_get_screen_width(int hardwareId) {
  (void)hardwareId;
    return winceapp_get_screen_width();
}
...
int lfjport_get_screen_height(int hardwareId) {
  (void)hardwareId;
    return winceapp_get_screen_height();
}
