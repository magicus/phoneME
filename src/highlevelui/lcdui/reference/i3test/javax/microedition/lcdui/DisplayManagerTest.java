...
public class DisplayManagerTest extends TestCase {
	...
	assertTrue(display.hasForeground);
	assertSame(display.accessor, Display.displayManagerImpl.foreground);
