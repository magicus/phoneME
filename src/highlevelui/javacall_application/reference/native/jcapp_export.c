 ...
 */
 ...
 void setSoftButtonsLabelsOnNativeLayer(unsigned short *uStr1, int len1,int sftbuttonIndex) {
	javacall_lcd_set_native_softbutton_label(uStr1, len1, sftbuttonIndex);
}
