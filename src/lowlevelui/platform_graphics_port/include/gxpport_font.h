...
#ifndef _GXPPORT_FONT_H_
#define _GXPPORT_FONT_H_

/**
 * @defgroup lowui_gxpport Platform Graphics Porting Interface
 * @ingroup lowui
 */
 ...
 */
extern void gxpport_get_fontinfo(int face, int style, int size,
 ...
 */
extern int gxpport_get_charswidth(int face, int style, int size,
