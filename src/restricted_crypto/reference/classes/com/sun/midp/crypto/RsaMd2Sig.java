...
/**
 * Implements RSA MD2 Signatures.
 */ 
public final class RsaMd2Sig extends Signature {
    /**
     * Expected prefix in the decrypted result when MD2 hashing is used
     * with RSA signing. This prefix is followed by the MD2 hash.
    ...
    /**
     * Constructs an RSA signature object that uses MD2 as 
     * message digest algorithm.
     *
     * @exception RuntimeException if MD2 is not available
     */
    public RsaMd2Sig() {
        try {
            rsaSig = new RSASig(PREFIX_MD2, MessageDigest.getInstance("MD2"));
