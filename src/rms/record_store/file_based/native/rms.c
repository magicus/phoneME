 ...
 * <ul>
 * @param filenameBase ID of the MIDlet suite that owns the record store
 ...
 */
int
rmsdb_remove_record_stores_for_suite(pcsl_string filenameBase) {
    int numberOfNames;
    pcsl_string* pNames;
    int i;
    int result = 1;
 ...
 */
long
rmsdb_get_rms_storage_size(pcsl_string filenameBase) {
    int numberOfNames;
    pcsl_string* pNames;
    int i;
    int used = 0;
