 ...
 */
KNIEXPORT KNI_RETURNTYPE_INT
Java_com_sun_kvem_io_j2me_btl2cap_L2CAPNetmonConnection_connect0() {
    static LimeFunction *f = NULL;
...
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_kvem_io_j2me_btl2cap_L2CAPNetmonConnection_disconnect0() {
    static LimeFunction *f = NULL;
    int md = KNI_GetParameterAsInt(1);
...
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_kvem_io_j2me_btl2cap_L2CAPNetmonConnection_read0() {
    static LimeFunction *f = NULL;
...
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_kvem_io_j2me_btl2cap_L2CAPNetmonConnection_write0() {
    static LimeFunction *f = NULL;
    DEBUG_PRINT("in btl2cap_L2CAPNetmonConnection_read0\n");
