...
wr.pld(0,"System.out.println(\"" + stubClsName + ".__getInstance() - instance found \");");
            wr.pl(3, "return (" + stubClsName + ")saved;");
            wr.pl(2, "}");
...
wr.pld(0,"System.out.println(\"" + stubClsName + "." + stubClsName + "() - internal constructor, field=\" + (fieldName == null ? \"null\" : \"'\" + fieldName + \"'\"));");
            ...
            wr.pl(3, "__objList.put(__getInternal(), this);");
            wr.pl(2, "}");
            wr.pl(1, "}");
            wr.pl(1, "// Finalizer");
...
wr.pld(4,"System.out.println(\"" + stubClsName + ".__getProxyClass()\");");
            ...
            if (!isInherit) {
                ...
                wr.pl(";");
                wr.pl(2, "__objList.put(proxy, fInstance);");
            } else {
                wr.pl(2, "Object proxy;");
                wr.pl(2, "try {");
        ...
        if (!isIface && isInherit) {
            ...
            wr.pl(3, "throw new RuntimeException(\"Cannot find " + pkgName + "." + prefix + "__AgentManager\" + cnfe.toString());");
            wr.pl(2, "}");
            ...
            wr.pl(2, "} catch (ClassNotFoundException cnfe) {");
            wr.pl(3, "throw new RuntimeException(\"Cannot find " + pkgName + "." + prefix + "__AgentInterface\" + cnfe.toString());");
            wr.pl(2, "}");
...
wr.pld(4,"System.out.println(\"It's my class!!\");");
            ...
            wr.pl(3, "throw new RuntimeException(e);");
            wr.pl(2, "}");
            wr.pl(1, "}");
...
wr.pld(4,"System.out.println(\"return from " + className + "." + (isCtor?"constructor"+(int)(num + 1):mem.getName())+ "\");");
                ...
                wr.pl(4, "__objList.put(__getInternal(), this);");
                wr.pl(3, "}");
            } else {
                if (isTranslatedClass(retType)) {
                    wr.p("Object result = ");
