...
public final class PiscesRendererMIDPImpl extends PathSink 
        implements PiscesRenderer {
    static {
        PiscesLibrary.load();
    }
...
//        System.out.println("not implemented");
     ...
     */
    public PiscesRendererMIDPImpl(Object data, int width, int height,
                          int offset, int scanlineStride, int pixelStride,
                          int type) {
        this((AbstractSurface)data);
    }

    public PiscesRendererMIDPImpl(AbstractSurface surface) {
        if (!messageShown) {
