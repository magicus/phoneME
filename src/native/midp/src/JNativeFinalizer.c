...
KNIEXPORT KNI_RETURNTYPE_VOID
KNIDECL(com_sun_pisces_NativeFinalizer_0004SurfaceNativeFinalizer_finalize) {
    KNI_StartHandles(2);
    KNI_DeclareHandle(objectHandle);
    ...
    surface_finalize(_ee, guardedHandle);
...
KNIEXPORT KNI_RETURNTYPE_VOID
KNIDECL(com_sun_pisces_NativeFinalizer_0004RendererNativeFinalizer_finalize) {
    KNI_StartHandles(2);
    KNI_DeclareHandle(objectHandle);
    KNI_DeclareHandle(guardedHandle);
...
KNIEXPORT KNI_RETURNTYPE_VOID
KNIDECL(com_sun_pisces_NativeFinalizer_00024RendererNativeFinalizer_finalize) {
    KNI_StartHandles(2);
    KNI_DeclareHandle(objectHandle);
    KNI_DeclareHandle(guardedHandle);
