 ...
 * protocol.  A <code>DatagramProtocolPermission</code> consists of a
 ...
 * @see Connector#open
 * @see "javax.microedition.io.UDPDatagramConnection" in <a href="http://www.jcp.org/en/jsr/detail?id=271">MIDP 3.0 Specification</a>
 */
public final class DatagramProtocolPermission extends GCFPermission {
  ...
  /**
   * Checks if this <code>DatagramProtocolPermission</code> object "implies"
   ...
   * <p>
   * <ul>
   * <li> <i>p</i> is an instanceof DatagramProtocolPermission, and
   * <p>
  ...
  /**
   * Checks two <code>DatagramProtocolPermission</code> objects for equality.
   * 
   * @param obj the object we are testing for equality with this object.
   *
   * @return <code>true</code> if <code>obj</code> is a
   * <code>DatagramProtocolPermission</code> and has the same URI string as
   * this <code>DatagramProtocolPermission</code> object.
   */
   ...
   * for <code>DatagramProtocolPermission</code>.
   *
   ...
   * <code>DatagramProtocolPermission</code> objects.
   * <p>
   * <code>DatagramProtocolPermission</code> objects must be stored in a
   * manner that allows
