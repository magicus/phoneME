 ...
 * protocol.  A <code>SSLProtocolPermission</code> consists of a
 * URI string but no actions list.
 * <p>
 * The URI string specifies a secure socket stream connection.
 ...
 *
 * @see Connector#open
 * @see "javax.microedition.io.SecureConnection" in <a href="http://www.jcp.org/en/jsr/detail?id=271">MIDP 3.0 Specification</a>
 */

public final class SSLProtocolPermission extends GCFPermission {

  /**
   * Creates a new <code>SSLProtocolPermission</code> with the
  ...
  /**
   * Checks if this <code>SSLProtocolPermission</code> object "implies"
   ...
   * <p>
   * <ul>
   * <li> <i>p</i> is an instanceof SSLProtocolPermission, and
   * <p>
  ...
  /**
   * Checks two <code>SSLProtocolPermission</code> objects for equality.
   * 
   * @param obj the object we are testing for equality with this object.
   *
   * @return <code>true</code> if <code>obj</code> is a
   * <code>SSLProtocolPermission</code> and has the same URI string as
   * this <code>SSLProtocolPermission</code> object.
   */
   ...
   * for <code>SSLProtocolPermission</code>.
   *
   ...
   * <code>SSLProtocolPermission</code> objects.
   * <p>
   * <code>SSLProtocolPermission</code> objects must be stored in a
   * manner that allows
