...
/* #endif */
     ...
     * This is distinct from doubleValue() to avoid the
     * case of a double rounding error, wherein the conversion
...
/* #endif */
	...
	if ( diff != 0L ) {
		...
		if ( sum !=0 && sum != 1 ) {
		    throw new RuntimeException(
/* #ifdef VERBOSE_EXCEPTIONS */
/// skipped                               "Assertion botch: "+sum+" carry out of division correction"
/* #endif */
                    );
                }
		q -= 1;
