...
typedef pthread_t midp_ThreadId;

/** platform invalid thread id */
#define MIDP_INVALID_NATIVE_THREAD_ID ((midp_ThreadId)0)

/** platform independent thread routine parameter type */
typedef void* midp_ThreadRoutineParameter;

/** platform independent thread routine type */
typedef void* midp_ThreadRoutine(midp_ThreadRoutineParameter param);
