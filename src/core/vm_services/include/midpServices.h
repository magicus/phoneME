...
typedef enum midp_SignalType {
    ...
    VOLUME_SIGNAL,
    JSR290_FLUID_SIGNAL,
    JSR290_LOAD_FINISH_SIGNAL,
    JSR290_INVALIDATE_SIGNAL,
    JSR290_LISTENER_COMPLETED_SIGNAL,
    JSR290_LISTENER_FAILED_SIGNAL,
    JSR290_LISTENER_PERCENTAGE_SIGNAL,
    JSR290_LISTENER_STARTED_SIGNAL,
    JSR290_LISTENER_WARNING_SIGNAL,
