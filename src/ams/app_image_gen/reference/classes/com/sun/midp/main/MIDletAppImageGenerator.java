...
public class MIDletAppImageGenerator {
     ...
     * @param tempFilename - name of temporary jar file.
     * @param suiteStorage - suite storage
     * @return true if application image was generated successfully,
     *            false otherwise
     */
    public static boolean createAppImage(String suiteId,
                                         String tempFilename,
