...
class ODTControllerEventListener implements EventListener {
    ...
    private ODTControllerEventConsumer odtControllerEventConsumer;
    ...
    public ODTControllerEventListener(
        ...
        eventQueue.registerEventListener(
            EventTypes.MIDP_ENABLE_ODD_EVENT, this);
    }
    ...
    public void process(Event event) {
        try {
            ...
            case EventTypes.MIDP_ENABLE_ODD_EVENT:
                odtControllerEventConsumer.handleEnableODDEvent();
                return;
            ...
            if (Logging.TRACE_ENABLED) {
                Logging.trace(t, "Error occurred processing ODD event " +
                              event.getType());
            }
        }
    }
