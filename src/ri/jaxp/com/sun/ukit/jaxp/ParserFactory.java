	...
	extends SAXParserFactory
{
		...
		throws ParserConfigurationException, SAXException
	{
		...
		SAXParserImp parser = new SAXParserImp();
		if ((namespaces == true) && (prefixes == false)) {
			parser.parser.setFeature(ParserSAX.FEATURE_NS, true);
			parser.parser.setFeature(ParserSAX.FEATURE_PREF, false);
		} else if ((namespaces == false) && (prefixes == true)) {
			parser.parser.setFeature(ParserSAX.FEATURE_PREF, true);
			parser.parser.setFeature(ParserSAX.FEATURE_NS, false);
		} else {
			throw new ParserConfigurationException("");
		}
		return parser;
