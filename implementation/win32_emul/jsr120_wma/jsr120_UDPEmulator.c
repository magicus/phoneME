...
#include <stdio.h>
/**
 * Temporary function for debugging purpoces.
 */
static void dbg_print(char* message) {
...
javacall_result process_UDPEmulator_cbs_incoming(unsigned char *pAddress,
    ...
    dbg_print("##javacall: process_UDPEmulator_cbs_incoming\n");
...
javacall_result init_wma_emulator() {
    ...
    dbg_print("##javacall: init_wma_emulator\n");
...
javacall_result finalize_wma_emulator() {
    ...
    dbg_print("##javacall: finalize_wma_emulator\n");
...
javacall_result try_process_wma_emulator(javacall_handle handle) {
    ...
    dbg_print("##javacall: try_process_wma_emulator\n");
...
void initializeWMASupport() {
    ...
    dbg_print("##javacall: initializeWMASupport\n");
...
void tearDownWMASupport() {
    ...
    dbg_print("##javacall: tearDownWMASupport\n");
