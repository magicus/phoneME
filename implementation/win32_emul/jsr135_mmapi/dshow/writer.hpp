...
bool dump_filter(IBaseFilter *pbf, nat32 indent = 0);
bool dump_filters(IFilterGraph *pfg, nat32 indent = 0);
bool dump_filter_graph(IFilterGraph *pfg, nat32 indent = 0);
