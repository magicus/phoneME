...
/**
 * skip_atoi
 * Read number from input buffer, convert it to integer, forward buffer
 *
 * @s: the source buffer
...
/**
 * javautil_vsnprintf - Format a string and place it in a buffer
...
/**
 * javautil_vsprintf - Format a string and place it in a buffer
 * @buf: The buffer to place the result into
 * @fmt: The format string to use
 * @args: Arguments for the format string
 */
